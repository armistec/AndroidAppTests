package com.example.corrinearmistead.mymapbox5;
...
/**
 * Display 2010 Washington State Census Data
 */
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(final MapboxMap mapboxMap) {
        ...
        FillLayer statePopulationLayer = new FillLayer("county-pop", "population");
        statePopulationLayer.withSourceLayer("WA_County_Pop");
        statePopulationLayer.setFilter(Filter.eq("isCounty", true));
        ...
        FillLayer countyPopulationLayer = new FillLayer("censusblock-pop", "population");
        countyPopulationLayer.withSourceLayer("WA_County_Pop");
        countyPopulationLayer.setFilter(Filter.eq("isCensusBlock", true));
        ...
        mapboxMap.setOnCameraChangeListener(new MapboxMap.OnCameraChangeListener() {
          ...
          public void onCameraChange(CameraPosition position) {
            ...
            if (position.zoom > ZOOM_THRESHOLD) {
              if (countyLayer != null && blockLayer != null) {
